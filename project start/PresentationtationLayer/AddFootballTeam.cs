...
{
    public partial class AddFootballTeam : Form
    {
        ...
        private void AddFootballTeam_Load(object sender, EventArgs e)
        {
        ...
        private void Donebutton1_Click(object sender, EventArgs e)
        {
            ...
            if (Validate())
            {
                ...
                bool vt = LoginLlogic.validdFootballteam(nwtm);//team name validation 
                ...
                if (vt)//team name validation
                {
                    ...
                    string table2team = "FootbalteamdataTable";
                    string table3player = "footbalplayerdataTable"; 
                    ...
                    bool vp1 = LoginLlogic.validfootballplayer(palyer1);
                    ...
                    if (vp1)//player1 validation to changed
                    {
                        LoginLlogic.InsertData(palyer1);
                        bool vp2 = LoginLlogic.validfootballplayer(palyer2);
                        //insert player1
                        if (vp2)//player2 validation
                        {
                            ...
                            bool vp3 = LoginLlogic.validfootballplayer(palyer3);
                            if (vp3)//player3 validation
                            {
                                ...
                                bool vp4 = LoginLlogic.validfootballplayer(palyer4);
                                if (vp4)//player4 validation
                                {

                                    //insert player4
                                    LoginLlogic.InsertData(palyer4);
                                    bool vp5 = LoginLlogic.validfootballplayer(palyer5);
                                    if (vp5)//player5 validation
                                    {
                                        //insert player5
                                        LoginLlogic.InsertData(palyer5);
                                        bool vp6 = LoginLlogic.validfootballplayer(palyer6);
                                        if (vp6)//player6 validation
                                        {
                                            //insert player6
                                            LoginLlogic.InsertData(palyer6);
                                            bool vp7 = LoginLlogic.validfootballplayer(palyer7);

                                            if (vp7)//player7 validation
                                            {
                                                //insert player
                                                LoginLlogic.InsertData(palyer7);
                                                bool vp8 = LoginLlogic.validfootballplayer(palyer8);
                                                if (vp8)//player8 validation
                                                {
                                                    //insert player8
                                                    LoginLlogic.InsertData(palyer8);
                                                    bool vp9 = LoginLlogic.validfootballplayer(palyer9);
                                                    if (vp9)//player9 validation
                                                    {

                                                        //insert player9
                                                        LoginLlogic.InsertData(palyer9);
                                                        bool vp10 = LoginLlogic.validfootballplayer(palyer10);
                                                        if (vp10)//player10 validation
                                                        {
                                                            //insert player10
                                                            LoginLlogic.InsertData(palyer10);
                                                            bool vp11 = LoginLlogic.validfootballplayer(palyer11);
                                                            if (vp11)//player11 validation
                                                            {
                                                                ...
                                                                LoginLlogic.InsertData(nwtm,table2team);   //make to parameters and pass to function
